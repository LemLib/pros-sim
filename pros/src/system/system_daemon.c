...
char *task_names[4] = {"User Operator Control (PROS)", "User Autonomous (PROS)", "User Disabled (PROS)",
                          "User Comp. Init. (PROS)"};
...
_Noreturn static void _system_daemon_task(__attribute((unused)) void * _) {
